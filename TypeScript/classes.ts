...
// class ke andar agar function create kiya to usee method kaha jata hai.
...
// '.this'----------------------------------------------------------------------------------------------------------------------------------------------------------------------
// '.this' is use referance.('this' ke andar referance data store hota hai)
...
//     random(){
//         console.log("lalala laaaa")
//     }
// }

class lap{
    constructor(public lapName:string){}
